...
const meta = {
  title: 'UI/Experimental/CarouselDialog2',
...
export const First: Story = {
  render: () => <CarouselDialog2 variant="first" slideCount={3} selectedIndex={0} />,
};

export const Middle: Story = {
  render: () => <CarouselDialog2 variant="middle" slideCount={3} selectedIndex={1} />,
};

export const Last: Story = {
  render: () => <CarouselDialog2 variant="last" slideCount={3} selectedIndex={2} />,
};
