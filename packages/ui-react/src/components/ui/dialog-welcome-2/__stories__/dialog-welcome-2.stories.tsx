...
const meta = {
  title: 'UI/Experimental/DialogWelcome2',
...
} satisfies Meta<typeof DialogWelcome2>;
...
export const Carousel: Story = {
  render: () => <DialogWelcome2 variant="carousel" slides={FEATURE_SLIDES} defaultOpen />,
};
