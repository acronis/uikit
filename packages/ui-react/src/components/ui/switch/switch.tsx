...
// off (`--ui-switch-container-color-inactive`) / on (`--ui-switch-container-color-active`,
...
>(({ className, ...props }, ref) => (
  <SwitchPrimitive.Root
    ...
    className={cn(
      ...
      'data-[unchecked]:bg-[var(--ui-switch-container-color-inactive)] data-[checked]:bg-[var(--ui-switch-container-color-active)]',
      'focus-visible:ring-[3px] focus-visible:ring-[var(--ui-focus-primary)]',
      'data-[disabled]:cursor-not-allowed data-[disabled]:bg-[var(--ui-switch-container-color-disabled)] data-[disabled]:shadow-[inset_0_0_0_1px_var(--ui-switch-container-border-color-disabled)]',
      className
    )}
    {...props}
  >
    <SwitchPrimitive.Thumb
      className={cn(
        'block size-3 rounded-full bg-[var(--ui-switch-toggle-color-off)] transition-transform',
        'data-[checked]:translate-x-4 data-[checked]:bg-[var(--ui-switch-toggle-color-on)]',
        'group-data-[disabled]:bg-[var(--ui-switch-toggle-color-disabled)]'
      )}
    />
  </SwitchPrimitive.Root>
));
