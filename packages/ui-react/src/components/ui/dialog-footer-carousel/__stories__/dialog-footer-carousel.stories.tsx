...
export const Start: Story = {
  render: () => <DialogFooterCarousel variant="start" slideCount={3} selectedIndex={0} />,
};

export const Middle: Story = {
  render: () => <DialogFooterCarousel variant="middle" slideCount={3} selectedIndex={1} />,
};

export const End: Story = {
  render: () => <DialogFooterCarousel variant="end" slideCount={3} selectedIndex={2} />,
};

export const Interactive: Story = {
  render: function InteractiveDialogFooterCarousel() {
    const slideCount = 4;
