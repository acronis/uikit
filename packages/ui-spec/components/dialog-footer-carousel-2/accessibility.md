# DialogFooterCarousel2 — accessibility
...
- DialogFooterCarousel2 is a plain layout container — no landmark role of its
  own. It's meant to live inside a dialog (e.g. `DialogWelcome2`), which owns
