...
// Source: @acronis-platform/design-tokens • brand: orange_tsukaeru_helpox • component: Chat
...
export default {
  theme: {
    extend: {
      ...
      "textColor": {
        "chat-menu-item-hint": "light-dark(rgb(97 101 107), rgb(135 139 146))",
        "chat-menu-item-label": "light-dark(rgb(24 25 27), rgb(244 245 245))"
      },
      "borderColor": {
        "chat-global-border-color": "light-dark(rgb(215 217 219), rgb(61 63 67))"
      },
      "fill": {
        "chat-menu-item-icon": "light-dark(rgb(73 76 80), rgb(201 204 207))"
      },
      "fontFamily": {
