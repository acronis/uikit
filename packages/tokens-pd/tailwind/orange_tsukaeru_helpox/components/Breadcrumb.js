...
// Source: @acronis-platform/design-tokens • brand: orange_tsukaeru_helpox • component: Breadcrumb
  ...
  theme: {
    extend: {
      "textColor": {
        ...
        "breadcrumb-link-label-idle": "light-dark(rgb(97 101 107), rgb(135 139 146))",
