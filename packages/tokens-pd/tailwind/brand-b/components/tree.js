...
export default {
  theme: {
    extend: {
      "backgroundColor": {
        "tree-global-active": "light-dark(rgb(209 240 237), rgb(4 73 67))",
        "tree-global-focus": "light-dark(rgb(226 245 244), rgb(3 58 54))",
        "tree-global-hover": "light-dark(rgb(226 245 244), rgb(3 58 54))",
      ...
      "fill": {
        "tree-global-active": "light-dark(rgb(51 153 145), rgb(51 153 145))",
        "tree-global-focus": "light-dark(rgb(51 153 145), rgb(51 153 145))",
        "tree-global-hover": "light-dark(rgb(51 153 145), rgb(51 153 145))",
        "tree-global-idle": "light-dark(rgb(51 153 145), rgb(51 153 145))"
      },
      "spacing": {
