...
// Source: @acronis-platform/design-tokens • brand: blue_yellow_uss_signal • component: InputSelect
...
export default {
  theme: {
    extend: {
      ...
      "fill": {
        "input-select-dropdown-item-global-icon-checked": "light-dark(rgb(24 25 27), rgb(244 245 245))",
        "input-select-dropdown-item-global-icon-collapse": "light-dark(rgb(24 25 27), rgb(244 245 245))",
        "input-select-dropdown-item-global-icon-tenant": "light-dark(rgb(24 25 27), rgb(244 245 245))",
        ...
        "input-select-normal-icon-expand-disabled": "light-dark(rgb(175 178 182), rgb(85 89 94))",
        "input-select-normal-icon-expand-hover": "light-dark(rgb(73 76 80), rgb(201 204 207))",
        "input-select-normal-icon-expand-idle": "light-dark(rgb(73 76 80), rgb(201 204 207))"
      },
      "fontFamily": {
