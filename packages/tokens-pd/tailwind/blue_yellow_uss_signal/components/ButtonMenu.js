...
// Source: @acronis-platform/design-tokens • brand: blue_yellow_uss_signal • component: ButtonMenu
...
export default {
  theme: {
    extend: {
      ...
      "textColor": {
        "button-menu-dropdown-extras-shortcut-label": "light-dark(rgb(97 101 107), rgb(135 139 146))",
