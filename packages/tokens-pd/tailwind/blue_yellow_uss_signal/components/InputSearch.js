...
// Source: @acronis-platform/design-tokens • brand: blue_yellow_uss_signal • component: InputSearch
  ...
  theme: {
    extend: {
      ...
      "textColor": {
        ...
        "input-search-placeholder-hover": "light-dark(rgb(97 101 107), rgb(135 139 146))",
        "input-search-placeholder-idle": "light-dark(rgb(97 101 107), rgb(135 139 146))",
