...
const PREFIX_RULES = [
  {
    // {semantic.colors.X.Y...} or {semantics.colors.X.Y...} → {colors.X.Y...}
    // (Figma renamed the group `semantic` → `semantics`; accept either.)
    match: parts => (parts[0] === 'semantic' || parts[0] === 'semantics') && parts[1] === 'colors' ? 2 : 0,
    emit: () => ['colors'],
  },
  {
