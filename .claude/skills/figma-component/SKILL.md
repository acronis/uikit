...
| File               | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `index.yaml`       | `component` PascalCase, `name` kebab, `status`, `category`, `since`, `figma.node`, `figma.codeConnect`. Add `visibility: internal` only if the component is a primitive not meant for direct dev use (consumed by other components, never imported standalone) — omit `deprecated` for a new component. Marking either requires the barrel-omission + docs-frontmatter + Storybook-tags conformance in `packages/ui-spec/__tests__/visibility.test.ts` to hold (see `/component-readiness`'s `VISIBLE` column). |
