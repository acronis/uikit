...
| File               | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `index.yaml`       | `component` PascalCase, `name` kebab, **`status: draft`**, `category`, `since`. **Omit the `figma:` block** (no node yet — it's optional in the schema). Add `visibility: internal` only if the legacy source is itself a not-for-direct-use primitive — omit `deprecated` for a new component. Either one requires the barrel-omission + docs-frontmatter + Storybook-tags conformance in `packages/ui-spec/__tests__/visibility.test.ts` (see `/component-readiness`'s `VISIBLE` column). |
